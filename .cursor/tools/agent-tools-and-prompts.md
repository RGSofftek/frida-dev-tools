...
- Ask to run a specific command: “Run `python resources/cli-tools/frida_lint.py check Actions.txt`.”
...
- “Fix the lint errors reported in resources/cli-tools/frida_lint.py.”
